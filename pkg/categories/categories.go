...
var All = []Def{
	...
	{Name: "PowerShell History", InternalKey: "powershell_history", Risk: types.RiskReview, MinPreset: Standard},
	...
	// Deep
	{Name: "Recycle Bin", InternalKey: "recycle_bin", Risk: types.RiskReview, MinPreset: Deep},
	...
	{Name: "Recent Documents", InternalKey: "recent_documents", Risk: types.RiskSafe, MinPreset: Deep},
