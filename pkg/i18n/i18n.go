...
var translations = map[string]map[string]string{
	"en": {
		...
		"dry_run":                 "[PREVIEW]",
		"hint_confirm":            "Enter: proceed  T: preview  Esc: back",
		"will_free":               "Will free",
		"cleaning":                "Cleaning...",
		...
		"cleanup_desc":            "Delete old or all backup copies.",
		"all_quarantines":         "All",
		"old_only":                "Old only",
		"mode":                    "Mode",
		"toggle_mode":             "toggle mode",
		"hint_cleanup":            "A: mode  T: preview  Enter: proceed  Esc: back",
		"settings":                "Settings",
		"language":                "Language",
	...
	"ru": {
		...
		"hint_confirm":            "Enter: очистить  T: предпросмотр  Esc: назад",
		...
		"hint_cleanup":            "A: режим  T: предпросмотр  Enter: запустить  Esc: назад",
		"settings":                "Настройки",
		"language":                "Язык",
