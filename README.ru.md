...
Просканируй систему в поисках кандидатов на очистку по 30+ категориям.
...
Очисти выбранные элементы. По умолчанию чистятся элементы **safe** и **review**. Опасные элементы требуют явного подтверждения.
