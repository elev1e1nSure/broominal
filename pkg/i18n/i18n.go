...
var translations = map[string]map[string]string{
	"en": {
		...
		"cat_desc_telegram_desktop_cache": "Downloaded images, videos, stickers and files from Telegram chats. Some may not be stored in the cloud.",
	...
	"ru": {
		...
		"cat_desc_telegram_desktop_cache": "Скачанные изображения, видео, стикеры и файлы из чатов Telegram. Часть файлов может не храниться в облаке.",
