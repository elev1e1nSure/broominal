...
|------------|----------|
| 🧹 **Умное сканирование** | Temp, Downloads, кэш браузеров, Корзина, логи, старые установщики, большие старые файлы, миниатюры, DirectX Shader, Delivery Optimization, WER, Discord, Steam, Windows Update, дампы, Nvidia, Telegram |
