...
var translations = map[string]map[string]string{
	"en": {
		...
		"cat_desc_telegram_desktop_cache": "Downloaded images, videos, stickers and files from Telegram chats. Stored locally and will be re-downloaded from the cloud when needed.",
	...
	"ru": {
		...
		"cat_desc_telegram_desktop_cache": "Скачанные изображения, видео, стикеры и файлы из чатов Telegram. Хранятся локально и будут перекачаны из облака при необходимости.",
