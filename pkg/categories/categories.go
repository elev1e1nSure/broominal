...
var All = []Def{
	...
	{Name: "Empty Folders", InternalKey: "empty_folders", Risk: types.RiskSafe, MinPreset: Quick},
	...
	{Name: "Service Cache", InternalKey: "service_cache", Risk: types.RiskSafe, MinPreset: Standard},
	...
	{Name: "Crash & Memory Dumps", InternalKey: "crash_memory_dumps", Risk: types.RiskReview, MinPreset: Standard},
	...
	{Name: "Font Cache", InternalKey: "font_cache", Risk: types.RiskSafe, MinPreset: Standard},
	...
	{Name: "Recent Documents", InternalKey: "recent_documents", Risk: types.RiskReview, MinPreset: Deep},
	{Name: "Old Chkdsk Files", InternalKey: "old_chkdsk_files", Risk: types.RiskReview, MinPreset: Deep},
	...
	{Name: "Windows.old", InternalKey: "windows_old", Risk: types.RiskReview, MinPreset: Deep},
}
