...
var translations = map[string]map[string]string{
	"en": {
		...
		"cat_desc_temp":                  "Windows temp files stored in %TEMP%. Automatically recreated by apps. Safe to clean.",
		"cat_desc_downloads":             "Files from your Downloads folder. Review before deletion to avoid losing important files.",
		"cat_desc_browser_cache":         "Browser cache (images, scripts). Speeds up websites. Safe — will be rebuilt on next visit.",
		"cat_desc_recycle_bin":           "Files already marked for deletion. Safe to empty.",
		"cat_desc_logs":                  "Application and system log files. Diagnostic info. Usually safe to remove.",
		"cat_desc_old_installers":        "Old installer packages (.msi, .exe). May be large. Check if you need to reinstall anything.",
		"cat_desc_large_old_files":       "Large files older than threshold. Review carefully — may contain important data.",
		"cat_desc_thumbnails_cache":      "Windows thumbnail cache. Rebuilds automatically. Safe to clean.",
		"cat_desc_directx_shader_cache":  "DirectX shader cache. Games recreate these. Safe to remove.",
		"cat_desc_delivery_optimization": "Windows Update delivery files. Shared with other PCs. Safe — will re-download.",
		"cat_desc_windows_error_reports": "Windows error report files. Sent to Microsoft for diagnostics. Safe to remove.",
		"cat_desc_discord_cache":         "Discord images, avatars and temporary data. Safe — will re-download.",
		"cat_desc_steam_cache":           "Steam downloaded game data and images. Safe — verified on launch.",
		"cat_desc_windows_update_cache":  "Windows Update downloaded packages. Safe — used for installation only.",
		"cat_desc_crash_memory_dumps":    "Crash dumps for debugging. Large files. Safe if not diagnosing crashes.",
		"cat_desc_nvidia_installer_leftovers": "NVIDIA installer temporary files. Safe after driver installation.",
		"cat_desc_telegram_desktop_cache": "Telegram images, stickers and files. Safe — will re-download from cloud.",
		"cat_desc_vscode_cache":          "VS Code extension cache and temp data. Safe — rebuilds on launch.",
		"cat_desc_edge_code_cache":       "Microsoft Edge cached scripts and data. Safe — rebuilds automatically.",
		"cat_desc_chrome_code_cache":     "Google Chrome cached scripts and data. Safe — rebuilds automatically.",
		"cat_desc_firefox_cache2":        "Firefox cached website data. Safe — rebuilds on next visit.",
		"cat_desc_old_temp_files":        "Old temp files forgotten by apps. Safe to remove.",
		"cat_desc_old_tmp_files":         "Legacy .tmp files from applications. Usually safe.",
		"cat_desc_old_log_files":         "Old application log files. Historical data. Usually safe.",
		"cat_desc_old_bak_files":         "Backup .bak files created by apps. Review — may be needed for recovery.",
		"cat_desc_empty_folders":         "Empty directories. Take no space. Completely safe.",
		"cat_desc_npm_cache":             "npm package cache. Re-downloads when needed. Safe to clean.",
		"cat_desc_pip_cache":             "Python pip package cache. Re-downloads when needed. Safe to clean.",
	...
	"ru": {
		...
		"cat_desc_temp":                  "Временные файлы Windows из %TEMP%. Автоматически создаются программами. Безопасно удалять.",
		"cat_desc_downloads":             "Файлы из папки Загрузки. Проверьте перед удалением, чтобы не потерять важное.",
		"cat_desc_browser_cache":         "Кэш браузеров (изображения, скрипты). Ускоряет сайты. Безопасно — пересоздастся при посещении.",
		"cat_desc_recycle_bin":           "Файлы в Корзине, уже помеченные на удаление. Безопасно очистить.",
		"cat_desc_logs":                  "Лог-файлы приложений и системы. Диагностическая информация. Обычно безопасно удалять.",
		"cat_desc_old_installers":        "Старые установщики (.msi, .exe). Могут быть большими. Проверьте, нужны ли для переустановки.",
		"cat_desc_large_old_files":       "Большие старые файлы. Проверьте внимательно — могут содержать важные данные.",
		"cat_desc_thumbnails_cache":      "Кэш миниатюр Windows. Пересоздается автоматически. Безопасно удалять.",
		"cat_desc_directx_shader_cache":  "Кэш шейдеров DirectX. Игры пересоздают сами. Безопасно удалять.",
		"cat_desc_delivery_optimization": "Файлы доставки обновлений Windows. Раздаются другим ПК. Безопасно — перекачаются.",
		"cat_desc_windows_error_reports": "Отчеты об ошибках Windows. Отправляются в Microsoft. Безопасно удалять.",
		"cat_desc_discord_cache":         "Кэш Discord: аватарки, изображения, временные данные. Безопасно — перекачается.",
		"cat_desc_steam_cache":           "Кэш Steam: данные игр, изображения. Безопасно — проверяется при запуске.",
		"cat_desc_windows_update_cache":  "Кэш обновлений Windows. Используется только для установки. Безопасно удалять.",
		"cat_desc_crash_memory_dumps":    "Дампы памяти для отладки. Большие файлы. Безопасно, если не диагностируете сбои.",
		"cat_desc_nvidia_installer_leftovers": "Временные файлы установщика NVIDIA. Безопасно после установки драйвера.",
		"cat_desc_telegram_desktop_cache": "Кэш Telegram: фото, стикеры, файлы. Безопасно — перекачается из облака.",
		"cat_desc_vscode_cache":          "Кэш VS Code: данные расширений. Безопасно — пересоздается при запуске.",
		"cat_desc_edge_code_cache":       "Кэш Edge: скрипты и данные сайтов. Безопасно — пересоздается автоматически.",
		"cat_desc_chrome_code_cache":     "Кэш Chrome: скрипты и данные сайтов. Безопасно — пересоздается автоматически.",
		"cat_desc_firefox_cache2":        "Кэш Firefox: данные сайтов. Безопасно — пересоздается при посещении.",
		"cat_desc_old_temp_files":        "Старые temp-файлы, забытые программами. Безопасно удалять.",
		"cat_desc_old_tmp_files":         "Устаревшие .tmp-файлы от приложений. Обычно безопасно удалять.",
		"cat_desc_old_log_files":         "Старые лог-файлы приложений. Исторические данные. Обычно безопасно.",
		"cat_desc_old_bak_files":         "Резервные копии .bak от приложений. Проверьте — могут понадобиться для восстановления.",
		"cat_desc_empty_folders":         "Пустые папки. Не занимают место. Абсолютно безопасно удалять.",
		"cat_desc_npm_cache":             "Кэш пакетов npm. Перекачается при необходимости. Безопасно удалять.",
		"cat_desc_pip_cache":             "Кэш пакетов Python pip. Перекачается при необходимости. Безопасно удалять.",
