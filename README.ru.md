...
- 🛡️ **безопасно по умолчанию** — файлы отправляются в карантин, а не удаляются
- 🔍 **прозрачно** — результаты сканирования, отчёты и манифесты — обычный json
- ↩️ **отменяемо** — восстанови любую очистку по id или верни последнюю
- 📋 **предсказуемо** — явные категории, уровни риска и исключения
- 🎛️ **интерактивно** — tui на bubbletea для сканирования, предпросмотра, dry-run и восстановления
