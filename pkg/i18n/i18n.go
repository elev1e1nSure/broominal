...
var translations = map[string]map[string]string{
	"en": {
		...
		"quarantine_locked":                   "Some backup files are in use by another program. Close the program and try again.",
	...
	"ru": {
		...
		"quarantine_locked":                   "Некоторые резервные копии используются другой программой. Закройте программу и повторите попытку.",
