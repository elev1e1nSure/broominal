...
var All = []Def{
	...
	{Name: "Windows Installer Patches", InternalKey: "windows_installer_patches", Risk: types.RiskReview, MinPreset: Deep},
	{Name: "Android SDK Cache", InternalKey: "android_cache", Risk: types.RiskSafe, MinPreset: Deep},
	{Name: "Service Cache", InternalKey: "service_cache", Risk: types.RiskReview, MinPreset: Deep},
	{Name: "Dev Package Cache", InternalKey: "dev_package_cache", Risk: types.RiskReview, MinPreset: Deep},
