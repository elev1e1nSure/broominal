...
**Broominal — CLI/TUI-утилита для очистки Windows, построенная вокруг одного правила: очистка должна быть обратимой.**

Она перемещает выбранные файлы в локальный карантин с JSON-манифестами и отчётами, чтобы каждую очистку можно было проверить и восстановить.
...
<td><strong>Безопасно по умолчанию</strong><br>Файлы перемещаются в карантин, а не удаляются безвозвратно.</td>
</tr>
<tr>
<td width="6" bgcolor="#00ADD8"></td>
<td><strong>Прозрачно</strong><br>Результаты сканирования, отчёты и манифесты хранятся в обычном JSON.</td>
</tr>
<tr>
<td width="6" bgcolor="#8957E5"></td>
<td><strong>Отменяемо</strong><br>Можно восстановить очистку по ID или вернуть последнюю очистку.</td>
</tr>
<tr>
<td width="6" bgcolor="#F0883E"></td>
<td><strong>Интерактивно</strong><br>TUI на Bubbletea для выбора категорий, предпросмотра, dry-run и восстановления.</td>
</tr>
<tr>
<td width="6" bgcolor="#8B949E"></td>
<td><strong>Мультиязычно</strong><br>Английский и русский с автоопределением при первом запуске.</td>
</tr>
</table>
